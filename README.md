...
<p align="center">
  <a href="https://github.com/slydien/nautobot-graphql-observability/actions"><img src="https://github.com/slydien/nautobot-graphql-observability/actions/workflows/ci.yml/badge.svg?branch=main"></a>
...
Full documentation is bundled with the app and available in the [`docs`](https://github.com/slydien/nautobot-graphql-observability/tree/main/docs) folder of this repository:
...
You can find all the Markdown source for the App documentation under the [`docs`](https://github.com/slydien/nautobot-graphql-observability/tree/main/docs) folder in this repository. For simple edits, a Markdown capable editor is sufficient: clone the repository and edit away.
...
For any questions or comments, please check the [FAQ](https://github.com/slydien/nautobot-graphql-observability/blob/main/docs/user/faq.md) first. Feel free to open an [issue](https://github.com/slydien/nautobot-graphql-observability/issues) on GitHub.
